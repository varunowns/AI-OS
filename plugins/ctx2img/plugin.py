...
def _generate_svg_placeholder(summary: str, style: str = "") -> bytes:
  ...
  <text x="400" y="420" text-anchor="middle" font-family="sans-serif" font-size="14" fill="rgba(255,255,255,0.7)">ctx2img · Nordrun</text>
  <text x="400" y="500" text-anchor="middle" font-family="sans-serif" font-size="12" fill="rgba(255,255,255,0.4)">Generated by Nordrun ctx2img plugin</text>
</svg>"""
